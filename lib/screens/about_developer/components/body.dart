          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                ...
                InkWell(
                  onTap: () async {
                    const String linkedInUrl = "https://www.linkedin.com/in/mohamadhaikal/";
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        const String githubUrl = "https://github.com/Mohamad-Haikal";
                    ...
                    IconButton(
                      ...
                      padding: EdgeInsets.all(16),
                      onPressed: () async {
                        const String instaUrl = "https://www.instagram.com/mohamad_haikel/";
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      padding: EdgeInsets.all(16),
                      onPressed: () async {
                        await submitAppReview(context, liked: true);
                      },
                    ),
                    Text(
                      "Liked the app?",
                    ...
                    IconButton(
                      ...
                      iconSize: 50,
                      onPressed: () async {
                        await submitAppReview(context, liked: false);
                      },
                    ),
                    Spacer(),
                  ],
