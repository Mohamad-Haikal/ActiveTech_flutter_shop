  ...
  Widget buildNewPhoneNumberField() {
    return TextFormField(
      ...
      validator: (value) {
        ...
        } else if (newPhoneNumberController.text.length != 12) {
  ...
  Widget buildCurrentPhoneNumberField() {
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        String? currentPhone;
        if (snapshot.hasData && snapshot.data != null) currentPhone = (snapshot.data!.data()! as Map)[UserDatabaseHelper.PHONE_KEY];
