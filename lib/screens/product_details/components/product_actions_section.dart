      ...
      builder: (context, productDetails, child) {
        return InkWell(
          onTap: () async {
            ...
            bool success = false;
            final future = UserDatabaseHelper().switchProductFavouriteStatus(product!.id, !productDetails.productFavStatus).then(
              (status) {
                success = status;
              },
            ).catchError(
            ...
            await showDialog(
              ...
              builder: (context) {
                return AsyncProgressDialog(
                  future,
                  message: Text(
                    productDetails.productFavStatus ? "Removing from Favourites" : "Adding to Favourites",
                  ),
                );
              },
            );
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: productDetails.productFavStatus ? Color(0xFFFFE6E6) : Color(0xFFF5F6F9),
